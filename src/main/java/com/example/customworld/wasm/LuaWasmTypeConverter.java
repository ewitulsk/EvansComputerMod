...
public class LuaWasmTypeConverter {
    ...
    static {
        try {
            ...
            CustomWorldMod.LOGGER.debug("LuaWasmTypeConverter initialized successfully");
        } catch (Exception e) {
            CustomWorldMod.LOGGER.debug("CC:Tweaked Lua types not available: {}", e.getMessage());
        }
    }
    ...
    public static Object[] parseJsonToArgs(String json) {
        ...
        try {
            ...
            CustomWorldMod.LOGGER.error("Failed to parse JSON arguments: {}", e.getMessage());
            return new Object[0];
        }
    }
    ...
    public static Object createArguments(Object[] args) {
        ...
        try {
            ...
            CustomWorldMod.LOGGER.error("Failed to create IArguments: {}", e.getMessage());
            return null;
        }
    }
