...
public class WasmCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        CustomWorldMod.LOGGER.info("Registered WASM command");
    }
    ...
    private static int executeWasm(CommandContext<CommandSourceStack> context, List<String> params) {
        ...
        try {
            ...
            CustomWorldMod.LOGGER.info("WASM execution successful: {}::{} = {}", 
            ...
            CustomWorldMod.LOGGER.error("WASM execution failed", e);
            return 0;
        }
    }
