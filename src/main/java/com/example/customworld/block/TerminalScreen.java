...
public class TerminalScreen extends AbstractContainerScreen<TerminalMenu> {
    ...
    private static final ResourceLocation TERMINAL_FONT =
            new ResourceLocation(CustomWorldMod.MODID, "terminal");
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        ...
        // Scroll up (positive delta) increases offset, scroll down decreases
        // Each scroll tick moves 3 lines
        int scrollAmount = (int) (delta * 3);
    ...
    private void sendInput(String input) {
        ...
        ModNetwork.CHANNEL.sendToServer(new TerminalInputPacket(
