...
public class PeripheralMethodInvoker {
    ...
    static {
        try {
            ...
            EvansComputerMod.LOGGER.debug("PeripheralMethodInvoker initialized successfully");
        } catch (Exception e) {
            EvansComputerMod.LOGGER.debug("CC:Tweaked APIs not available for method invocation: {}", e.getMessage());
        }
    }
    ...
    public String invokeMethod(Object peripheral, String methodName, String jsonArgs, @Nullable MinecraftServer server) {
        ...
        try {
            ...
            if (iDynamicPeripheralClass != null && iDynamicPeripheralClass.isInstance(peripheral)) {
                EvansComputerMod.LOGGER.debug("Method {} not found as @LuaFunction, trying IDynamicPeripheral", methodName);
            ...
            EvansComputerMod.LOGGER.error("Error invoking peripheral method {}: {}", methodName, e.getMessage());
    ...
    private String invokeDynamicMethod(Object peripheral, String methodName, Object[] args, @Nullable MinecraftServer server) {
        try {
            ...
            EvansComputerMod.LOGGER.error("Error invoking dynamic method {}: {}", methodName, e.getMessage());
    ...
    private String invokeAnnotatedMethod(Object peripheral, String methodName, Object[] args, @Nullable MinecraftServer server) {
        try {
            ...
            EvansComputerMod.LOGGER.error("Error invoking annotated method {}: {}", methodName, cause.getMessage());
