...
fn cmd_help() {
    ...
    println("  terminal.sleep(s)      - Sleep for s seconds");
    println("  exit() or Ctrl+D       - Exit Python");
    println("");
    println("=== Advanced Peripherals Integration ===");
    println("");
    println("Player Detection:");
    println("  player_detector_available()");
    println("  get_online_players() -> list");
    println("  get_players_in_range(r) -> list");
    println("  is_player_in_range(r, name) -> bool");
    println("  get_player_count() -> int");
    println("  get_player_info(name) -> dict");
    println("");
    println("Environment Detection:");
    println("  environment_available()");
    println("  get_biome() -> str");
    println("  get_time() -> int (ticks)");
    println("  get_moon_id() / get_moon_name()");
    println("  is_raining() / is_thunder() / is_sunny()");
    println("  get_dimension() / list_dimensions()");
    println("  get_sky_light_level() / get_block_light_level()");
    println("  get_day_light_level()");
    println("  is_slime_chunk() -> bool");
    println("  scan_entities(radius) -> json");
    println("");
    println("Chat Box:");
    println("  chat_available()");
    println("  send_chat(msg) -> int (count)");
    println("  send_chat_to_player(player, msg) -> bool");
    println("  send_toast(player, title, msg) -> bool");
    println("");
    println("Geo Scanner:");
    println("  geo_scanner_available()");
    println("  geo_scan(radius) -> json");
    println("  geo_chunk_analyze() -> json (ore counts)");
    println("  geo_scan_cost(radius) -> int");
    println("");
    println("Block Reader:");
    println("  block_reader_available()");
    println("  get_block_name() -> str");
    println("  get_block_data() -> json (NBT)");
    println("  get_block_states() -> json");
    println("  is_tile_entity() -> bool");
    println("");
    println("Energy Detector:");
    println("  energy_detector_available()");
    println("  get_energy_transfer_rate() -> int");
    println("  get_energy_transfer_limit() -> int");
    println("  set_energy_transfer_limit(rate) -> bool");
    println("");
    println("NBT Storage:");
    println("  nbt_storage_available()");
    println("  nbt_read() -> json");
    println("  nbt_write(json) -> bool");
    println("");
