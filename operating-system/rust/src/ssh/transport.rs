...
impl SshTransport {
    pub fn new(is_server: bool) -> Self {
        Self {
            ...
            is_server,
            our_version: kex::VERSION_STRING.to_string(),
    ...
    pub fn set_peer_version(&mut self, line: &str) -> bool {
        ...
        if trimmed.starts_with("SSH-2.0-") {
            self.peer_version = trimmed.to_string();
    ...
    pub fn build_kexinit_packet(&mut self) -> Vec<u8> {
        ...
        match &self.state {
            TransportState::WaitingForKexInit => {
    ...
    pub fn set_keys(
        ...
        // Derive keys: A=IV_c2s, B=IV_s2c, C=key_c2s, D=key_s2c
